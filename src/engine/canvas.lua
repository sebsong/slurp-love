...
function Canvas.load()
    ...
    Canvas.scaledCanvasToScreenTransform = love.math.newTransform(xAdjust, yAdjust)

    Canvas.canvasToScreenTransform = love.math.newTransform(xAdjust, yAdjust, 0, Canvas.scale, Canvas.scale)
