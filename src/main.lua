...
function love.load()
	...
	local tileset = NewTileset("assets/tilemap/tileset.png", 16, 16, 8) -- TODO: maybe switch to reading lua exported tiled files to get the grid size info
	Tilemap = NewTilemap("assets/tilemap/map.csv", tileset, true)
